...
var useAutocomplete = /* @__PURE__ */ __name((props) => {
  var _a, _b;
  const { queryResult, defaultValueQueryResult, onSearch, overtime } = useSelectCore(props);
  return {
    autocompleteProps: {
      options: unionWith(
...
var RegisterPage = /* @__PURE__ */ __name(({
  ...
  const Content = /* @__PURE__ */ React20.createElement(Card3, { ...contentProps ?? {} }, /* @__PURE__ */ React20.createElement(CardContent3, { sx: { p: "32px", "&:last-child": { pb: "32px" } } }, /* @__PURE__ */ React20.createElement(
    ...
    /* @__PURE__ */ React20.createElement(Typography10, { variant: "body2", component: "span", fontSize: "12px" }, translate("pages.login.buttons.haveAccount", "Have an account?")),
    /* @__PURE__ */ React20.createElement(
      MuiLink4,
      {
        ml: "4px",
...
var DateField = /* @__PURE__ */ __name(({
  ...
  return /* @__PURE__ */ React43.createElement(Typography20, { variant: "body2", ...rest }, dayjs(value).locale(locales || defaultLocale).format(dateFormat));
}, "DateField");
