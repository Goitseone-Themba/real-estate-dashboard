...
var r = (n, e) => nt2(n, "name", { value: e, configurable: true });
var g = r((n) => n.replace(/\w\S*/g, (e) => e.charAt(0).toUpperCase() + e.slice(1).toLowerCase()), "capitalize");
var I = r(() => {
  let n = G(), { resource: e, resources: p, id: c, action: y } = z(), l = Z(), d = lt(), b = ge(), { mutate: H } = ro(), { push: K, list: Pt, create: wt, show: Tt, edit: kt } = ce(), V = nt(), $ = (0, import_react3.useContext)(import_kbar3.KBarContext), { can: a } = dR(), [B, j] = (0, import_react3.useState)([]);
...
var ge2 = r(({ children: n, commandBarProps: e }) => import_react2.default.createElement(w.Provider, { value: e ?? {} }, import_react2.default.createElement(import_kbar.KBarProvider, null, n)), "RefineKbarProvider");
