...
import {
  GridLogicOperator
} from "./chunk-JZ6PSMJK.js";
import {
  C
} from "./chunk-4VQSCOYN.js";
import {
  FormProvider
} from "./chunk-SSMIDYIU.js";
import {
  $r,
  At,
  CR,
  ...
  yr,
  z
} from "./chunk-G5N6JQXD.js";
import "./chunk-WTPB6HYX.js";
import {
  Breadcrumbs_default,
  CardActions_default,
  CardContent_default,
...
import {
  ...
  TextField_default,
  Tooltip_default
} from "./chunk-M2JJVCPW.js";
import {
  Toolbar_default
} from "./chunk-OJX32N5C.js";
import "./chunk-VMDB2G2I.js";
import {
  IconButton_default
} from "./chunk-GXE5ATMT.js";
import {
  Avatar_default
} from "./chunk-QDCP7SC3.js";
import "./chunk-RVIWH5SX.js";
import {
  AppBar_default
} from "./chunk-LEVNVO2I.js";
import {
  Paper_default
} from "./chunk-DQNNK6HG.js";
import {
  Divider_default,
  ListItemIcon_default,
  ListItemText_default
} from "./chunk-RQJP6PDW.js";
import "./chunk-NPNT5DTN.js";
import {
  require_react_dom
} from "./chunk-7QQWTS7N.js";
import {
  Stack_default
} from "./chunk-7HYATJZE.js";
import {
  Typography_default
} from "./chunk-IN7Z4EFU.js";
import {
  init_utils as init_utils2,
  useId_default
} from "./chunk-B7XJG4DW.js";
import {
  SvgIcon_default,
  createSvgIcon,
  init_SvgIcon
} from "./chunk-R7U4IVFE.js";
import "./chunk-652BLKAB.js";
import "./chunk-FOZ2JGTJ.js";
import {
  Container_default
} from "./chunk-ROKQMCMC.js";
import {
  capitalize_default
} from "./chunk-BF5VCNNM.js";
import {
  Box_default
} from "./chunk-WUUED63C.js";
import "./chunk-IHHME47M.js";
import {
  useTheme
} from "./chunk-HVGI2AT4.js";
import {
  darken,
  emphasize
} from "./chunk-6GSO3KG5.js";
import {
  chainPropTypes,
  init_utils
} from "./chunk-IHMU27PV.js";
import {
  styled_default
} from "./chunk-B56F25RO.js";
import {
  useThemeProps
} from "./chunk-MFE43QW3.js";
import {
  _extends,
...
var Sider = __name(({
  ...
  const { hasDashboard } = ne();
  const translate = G();
  const { warnWhen, setWarnWhen } = dt();
  const { menuItems, selectedKey, defaultOpenKeys } = bu({ meta });
  const isExistAuthentication = qr();
  const TitleFromContext = qn();
  const authProvider = J();
  const { mutate: mutateLogout } = yr({
...
var useAutocomplete = __name((props) => {
  var _a, _b;
  const { queryResult, defaultValueQueryResult, onSearch, overtime } = CR(props);
  return {
    autocompleteProps: {
...
function useDataGrid({
  ...
  const liveMode = Vs(liveModeFromProp);
...
var WelcomePage = __name(() => {
  return import_react19.default.createElement(Ku, null);
}, "WelcomePage");
...
var RegisterPage = __name(({
  ...
  const authProvider = J();
  const { mutate: registerMutate, isLoading } = jr({
    v3LegacyAuthProviderCompatible: Boolean(authProvider == null ? void 0 : authProvider.isLegacy)
  });
  const translate = G();
  const routerType = Z();
...
var UpdatePasswordPage = __name(({
  ...
  const authProvider = J();
  const { mutate: update, isLoading } = Jr({
    v3LegacyAuthProviderCompatible: Boolean(authProvider == null ? void 0 : authProvider.isLegacy)
  });
  const translate = G();
...
var Edit = __name(({
  ...
  const { mutationMode: mutationModeContext } = ke();
...
var CreateButton = __name(({
  ...
  const { to, label, title, disabled, hidden, LinkComponent } = Jb(
    {
...
var EditButton = __name(({
  ...
  const { to, label, title, hidden, disabled, LinkComponent } = Zb({
    resource: resourceNameFromProps ?? resourceNameOrRouteName,
    id: recordItemId,
    accessControl,
    meta
...
var ShowButton = __name(({
  ...
  const { to, label, title, hidden, disabled, LinkComponent } = Xb({
    resource: resourceNameFromProps ?? resourceNameOrRouteName,
    id: recordItemId,
    accessControl,
    meta
...
var ListButton = __name(({
  ...
  const { to, label, title, hidden, disabled, LinkComponent } = qb({
    resource: resourceNameFromProps ?? resourceNameOrRouteName,
    meta,
    accessControl
  });
...
var CloneButton = __name(({
  ...
  const { to, label, title, hidden, disabled, LinkComponent } = Yb({
    resource: resourceNameFromProps ?? resourceNameOrRouteName,
    id: recordItemId,
    meta,
    accessControl
...
var Breadcrumb = __name(({
  ...
  const { hasDashboard } = ne();
  const { resources } = z();
  const rootRouteResource = Go("/", resources);
